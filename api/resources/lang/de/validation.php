...
return [
    ...
    */
    ...
    'correct_airfield'     => 'Das Feld :attribute muss :value sein.',
    ...
    'inadmissible_if'      => 'Das Feld :attribute ist unzulässig wenn die Felder :values vorhanden sind.',
    ...
    'not_between_date'     => 'Das Feld :attribute muss ein Datum außerhalb von :startDate und :endDate sein.',
    ...
    */
    ...
    'attributes' => [
        ...
        'gender'              => 'Geschlecht',
        'is_account_active'   => 'Benutzerkonto aktiviert',
        'is_active'           => 'Aktiviert',
        'language_code'       => 'Sprachcode',
        'lastname'            => 'Nachname',
        'locale'              => 'Bevorzugte Sprache',
        'maintenance_at'      => 'Wartung bei',
        ...
        'phone'               => 'Telefon',
        'pilot_id'            => 'Pilot',
        'pilot_signature'     => 'Pilotenunterschrift',
        'postal'              => 'Postleitzahl',
        'qualification'       => 'Befähigung',
        'qualifications'      => 'Befähigungen',
        'region_id'           => 'Region',
        'registration'        => 'Luftfahrzeugkennzeichen',
